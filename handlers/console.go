...
var upgrader = websocket.Upgrader{
	CheckOrigin: func(r *http.Request) bool {
		...
		// Non-browser clients send no Origin and are allowed (the API key is
		// still required). Browsers always send Origin, so a cross-site page
		// is rejected unless its origin is allow-listed.
